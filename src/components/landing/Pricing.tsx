...
const plans = [
  {
    ...
    price: '$0',
    period: '/mo',
    desc: 'For teams exploring voice AI. No card required.',
    cta: 'Get started',
  ...
  },
  {
    ...
    price: '$0.09',
    period: '/min',
    desc: 'For teams shipping voice agents to production.',
    ...
    features: [
      'Unlimited agents',
      'All 13 languages · mid-call switching',
      'Calendar · CRM · webhook tools',
      'Latency SLA 400ms p95',
      'Email + Slack support',
    ],
  },
  {
    ...
    price: 'Custom',
    period: '',
    desc: 'For organizations with high volume and compliance needs.',
    cta: 'Talk to sales',
    ctaClass: 'btn btn-secondary btn-lg',
    href: '#',
    featured: false,
    features: [
      'Volume pricing from $0.04/min',
      'Dedicated capacity · regional residency',
      'SOC 2 · HIPAA · custom DPA',
      'SAML SSO · audit logs',
      'Named CSM · 99.95% uptime',
    ],
  },
];
